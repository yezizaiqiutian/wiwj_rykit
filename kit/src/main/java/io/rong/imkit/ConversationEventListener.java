...
public interface ConversationEventListener {
    ...
    /**
     * /~english
     * Call back this method when you save a draft in a conversation
     *
    ...
    /**
     * /~english
     * Depending on the conversation type, clear all chat message records for a conversation and call back this method.
     *
    ...
    /**
     * /~english
     * This method is called back when all messages in a conversation are cleared from the unread state.
     *
     * @param type Conversation type Incoming ConversationType.CHATROOM is not supported
     * @param targetId Target Id Depending on the conversationType, it may be user Id, discussion group Id and group Id
     */
    ...
    /**
     * /~english
     * The callback when a conversation is deleted from the conversation list.
     *
     * @param type Conversation type Incoming ConversationType.CHATROOM is not supported
     * @param targetId Target Id Depending on the conversationType, it may be user Id, discussion group Id and group Id
     */
    ...
    /**
     * /~english
     * Clear a certain type of conversation.
     *
