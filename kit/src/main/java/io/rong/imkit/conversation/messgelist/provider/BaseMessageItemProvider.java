...
//            }
    ...
    /**
     * /~english
     * Set the value of each view in the message view
     *
     * @param holder ViewHolder
     ...
     * @param list List
     * @param listener ViewModel's click event listener. If the click event of a sub-view shall be handled by ViewModel, it can be called back through this listener.
     */
    ...
    /**
     * /~english
     * @return Whether the group or discussion group displays the read receipt of the message. By default, only the text message display subclass can override this method.
     */
    ...
    /**
     * /~english
     * Judge whether it is the type of message that shall be displayed in this template according to the content of the message
     *
