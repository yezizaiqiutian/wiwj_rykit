...
public class NotificationConfig {
    ...
    public interface Interceptor {
        ...
        /**
         * /~english
         * Generally whether to intercept this local notification is used to customize the display of local notifications.
         *
         * @param message  Message corresponding to local notification
         * @return Whether to intercept. True indicates to intercept local notifications. SDK does not pop up notifications and it shall be handled by users themselves. False indicates not to intercept, and local notifications are displayed by SDK.
         */
        ...
        /**
         * /~english
         * Callback for setting local notification PendingIntent. In this way, the application layer can change the settings in PendingIntent to customize the click behavior of local notifications. When you click local notification, SDK jumps to the corresponding conversation page by default.
         *
         * @param pendingIntent SDK default PendingIntent
         * @param intent Intent carried in pendingIntent The following information is available through intent: intent.GettringExtra(RouteUtils.CONVERSATION_TYPE); intent.GettringExtra(RouteUtils.TARGET_ID); intent.getParcelableExtra(RouteUtils.MESSAGE);
        ...
        /**
         * /~english
         * Whether it is a high priority message. High-priority messages are not controlled by global silence time and conversation do not Disturb, e.g. @ messages.
         *
        ...
        /**
         * /~english
         * Callback before the default channel is registered You can use this method to intercept and modify the configuration in the default channel, and return the modified channel.
         *
