...
public interface IConversationUIRenderer {
    ...
    /**
     * /~english
     * After entering the conversation page, initialize each UI renderer.
     *
    ...
    /**
     * /~english
     * Conversation page rendering event callback.
     *
     * @param event Render event
     * @return Whether the event is consumed. The true event is consumed by this renderer, and the conversation page is no longer processed; false indicates no consumption and the conversation page is handled by default.
     */
    ...
    /**
     * /~english
     * Callback when you press the return key
     *
    ...
    /**
     * /~english
     * Callback when you exit the conversation page.
     */
    void onDestroy();
}
