...
public class MessageViewModel extends AndroidViewModel implements MessageEventListener {
    ...
    public MessageViewModel(@NonNull Application application) {
        ...
        IMCenter.getInstance().addConnectionStatusListenerWithLastStatus(mConnectionStatusListener);
    ...
    /**
     * /~english
     * Initialize load local message and drop down load history message
     */
    ...
    /**
     * /~english
     * Click Historical message in normal status and click New message bar in bar history status
     */
