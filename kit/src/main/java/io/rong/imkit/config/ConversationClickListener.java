...
public interface ConversationClickListener {
    ...
    /**
     * /~english
     * Execute when the user portrait is clicked.
     *
    ...
    /**
     * /~english
     * Execute when the user portrait is held.
     *
     * @param context          Context
     * @param conversationType -Conversation type
     * @param user             Information about the user who is clicked on.
    ...
    /**
     * /~english
     * Executes when the message is clicked.
     *
     * @param context Context
     * @param view    The View that triggers the click.
     * @param message The physical information of the message that is clicked.
     * @return If the user handles the logical processing after clicking, return true, otherwise return false. False is handled by using the default processing method of RongCloud.
     */
    ...
    /**
     * /~english
     * Executes when the holdes the message.
     *
     * @param context Context
     * @param view    The View that triggers the click.
     * @param message The entity information of the message that has been pressed for a long time.
     * @return If the user handles the logical processing after holding, return true, otherwise return false. False is handled by using the default processing method of RongCloud.
     */
    ...
    /**
     * /~english
     * Executes when the link message is clicked.
     *
     * @param context Context
    ...
    /**
     * /~english
     * Execute when the read receipt status is clicked
     *
     * @param context  Context
