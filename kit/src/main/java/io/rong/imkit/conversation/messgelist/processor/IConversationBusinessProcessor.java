...
/**
 * /~english
 * conversation service processor
 */
public interface IConversationBusinessProcessor {
    ...
    /**
     * /~english
     * Initialization for the first time, binding events, etc
     *
    ...
    /**
     * /~english
     * Receive messages and call back this interface
     *
    ...
    /**
     * /~english
     * Command message received, (message with messagetag of none or status)
     *
     * @param messageViewModel MessageViewModel
     * @param message          Received message object
