...
public class EasyVideoPlayer extends FrameLayout implements IUserMethods, TextureView.SurfaceTextureListener,
    ...
    private void initPlayView() {
        ...
        LayoutParams imageViewPlayParam = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private void initCloseView() {
        ...
        LayoutParams imageViewCloseParam = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    private void initSightListView() {
        ...
        LayoutParams imageViewSightListParam = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT);
