...
public class CameraView extends RelativeLayout implements SurfaceHolder.Callback,
    ...
    private void initRetryView() {
        ...
        LayoutParams imageViewRetryParam = new LayoutParams(controlIconWidth, controlIconWidth);
    ...
    private void initPlayControlView() {
        ...
        LayoutParams imageViewPlayControlParam = new LayoutParams(controlIconWidth, controlIconWidth);
