...
public interface IClickActions {
    ...
    /**
     * /~english
     * Get the icon of the click button
     *
     * @param context Context
     * @return If the Drawable of the image shall be highlighted or grayed out, the return type is selector to display the drawable in enable or disable status, respectively
     */
     ...
     *
     * @param curFragment Please be careful not to hold the fragment, in the current Fragment, otherwise it will easily cause memory leakage.
     */
