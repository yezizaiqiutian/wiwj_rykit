...
/**
 * /~english
 * Listeners that operate on the conversation list interface.
 */
public interface ConversationListBehaviorListener {
    ...
    /**
     * /~english
     * Execute when the conversation portrait is clicked.
     *
     * @param context Context
     * @param conversationType Conversation type
     * @param targetId Id of the user clicked.
     * @return If the user handles the logical processing after clicking, return true, otherwise return false. False is handled by using the default processing method of Fuxing Cloud.
     */
    ...
    /**
     * /~english
     * Execute when the conversation portrait is held.
     *
     * @param context Context
     * @param conversationType Conversation type
     * @param targetId Id of the user clicked.
    ...
    /**
     * /~english
     * Executes when the item in the conversation list is held.
     *
     * @param context Context
     * @param view View that triggers the click.
     * @param conversation Conversation entries for holding.
     * @return If the user handles the logical processing after the hold conversation by himself, return true, otherwise return false,false to follow the default processing mode of RongCloud.
     */
    ...
    /**
     * /~english
     * Execute when the item in the conversation list is clicked.
     *
     * @param context Context
     * @param view  The View that triggers the click.
     * @param conversation Conversation entry.
     * @return If the user handles the logical processing after clicking conversation by himself, return true, otherwise return false. False is handled by using the default processing method of Rong Cloud.
     */
