...
public interface IEmoticonTab {
    ...
    /**
     * /~english
     * Construct a small icon for tab to display in tab bar.
     *
    ...
    /**
     * /~english
     * Call back this method when the emoji panel slides left and right.
     *
    ...
    /**
     * /~english
     * Return the update information of the input box corresponding to the tab page
     *
