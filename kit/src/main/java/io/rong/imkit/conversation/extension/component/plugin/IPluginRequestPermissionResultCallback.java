...
public interface IPluginRequestPermissionResultCallback {
    ...
    /**
     * /~english
     * This request code should be used for all plugin application permissions.
     */
    ...
    /**
     * /~english
     * boolean onRequestPermissionResult(Fragment fragment, RongExtension extension, int requestCode, java.lang.String[] permissions, int[] grantResults)
     *
     * @param fragment Fragment
     * @param extension RongExtension
     ...
     * @return True, plugin has handled the user authorization result by itself; false,plugin has not handled the user authorization result by itself.
     */
